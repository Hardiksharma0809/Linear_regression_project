...
from source.components.model_trainer import Model_trainer
...
if __name__=="__main__":   
    ...
    train_data,test_data,_  = Data_transfromation_obj.initiate_data_transformation(train_data,test_data)
